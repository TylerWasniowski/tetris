...
namespace tetris {
  ...
  const array<array<array<bool, PIECE_SIZE>, PIECE_SIZE>, NUM_SHAPES> SHAPES = { BLANK_SHAPE, STRAIGHT_SHAPE, L_SHAPE, FLIPPED_L_SHAPE, ZIG_ZAG_SHAPE, FLIPPED_ZIG_ZAG_SHAPE, SQUARE_SHAPE, T_SHAPE };
}
