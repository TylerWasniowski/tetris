...
const array<array<bool, PIECE_SIZE>, PIECE_SIZE> T_SHAPE = {
    {{false, false, false, false},
     ...
     {false, false, true, false}}};
const array<array<bool, PIECE_SIZE>, PIECE_SIZE> HAT_SHAPE = {
    {{false, false, false, false},
     {false, true, true, true},
     {false, true, false, true},
     {false, false, false, false}}};
const array<array<bool, PIECE_SIZE>, PIECE_SIZE> FINGER_SHAPE = {
    {{false, false, false, false},
     {true, true, true, false},
     {false, true, true, false},
     {false, false, false, false}}};
const array<array<bool, PIECE_SIZE>, PIECE_SIZE> FLIPPED_FINGER_SHAPE = {
    {{false, false, false, false},
     {false, true, true, true},
     {false, true, true, false},
     {false, false, false, false}}};
...
const array<array<array<bool, PIECE_SIZE>, PIECE_SIZE>, NUM_SHAPES> SHAPES = {
    BLANK_SHAPE, STRAIGHT_SHAPE, SQUARE_SHAPE, L_SHAPE, T_SHAPE, HAT_SHAPE,
    FINGER_SHAPE, FLIPPED_FINGER_SHAPE};
}
...
class Board {
 ...
 public:
  Board() {
    ...
    pieces[i++] = new Piece(HAT_SHAPE);
    pieces[i++] = new Piece(FINGER_SHAPE);
    pieces[i++] = new Piece(FLIPPED_FINGER_SHAPE);
  }
