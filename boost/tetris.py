...
class Tetris:
    def __init__(self):
        ...
        self.temp_state = self.getBoardArray(self.board.rend(0, 0, 0, 0))
    ...
    # def getPreviousBoard(self, board):
    #     return self.boardArray
    ...
    def getNextStates(self):
        ...
        for move in self.getMovesArray(self.board.getMoves()):
            ...
            temp_state = self.getBoardArray(render)
...
class DQN:
    ...
    def train(self, batch_size=32, epochs=3):
        ...
        # for i, (current_state, _, _, reward) in enumerate(batch):
...
def train_model(tetris, dqn, batch_size, epochs, episodes, train_every):
    ...
    for episode in tqdm(range(episodes)):
        ...
        while notGameOver:
            ...
            next_states = tetris.getNextStates()
            # best_state, best_action = dqn.best_state(next_states)
            ...
            state_str = ""
            for r in range(tetris.current_state.shape[0]):
                for c in range(tetris.current_state.shape[1]):
        ...
        movesPlayed.append(numberOfMoves)
...
def main():
    ...
    train_model(tetris, dqn, batch_size=32,
                epochs=2, episodes=1, train_every=5)
